...
<CardGrid>
    <Card title="Integrity Verification" icon="approve-check-circle">
    ...
    <Card title="Aggregation" icon="list-format">
    ...
    <Card title="Format Transformation" icon="translate">
...
<Steps>
    ...
    **Receive and Validate**
    ...
    <div>
    **Aggregate and Enrich (if needed)**
